    ...
    while msa.player1_cards:
        ...
        if strats[second] == "me":
            if second not in msa.duo:
                card2 = get_solo_second_card_3_3(msa, second, qlearning)
            else:
                card2 = get_duo_second_card_3_3(msa, second, qlearning)
        ...
        if strats[third] == "me":
            if third in msa.duo:
                card3 = get_solo_third_card_3_3(msa, third, qlearning)
            else:
                card3 = get_duo_third_card_3_3(msa, third, qlearning)
